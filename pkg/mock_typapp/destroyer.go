...
// Source: github.com/typical-go/typical-go/pkg/typapp (interfaces: Destroyer)
...
func (m *MockDestroyer) Destructors() []*typapp.Destructor {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Destructors")
	ret0, _ := ret[0].([]*typapp.Destructor)
	return ret0
}
