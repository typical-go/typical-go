...
var (
	_ typcore.Runner  = (*ReactDemoModule)(nil)
	_ typcore.Cleaner = (*ReactDemoModule)(nil)
)
...
// Run the react-demo
func (m *ReactDemoModule) Run(c *typcore.CliContext) (err error) {
...
func (m *ReactDemoModule) Clean(c *typcore.CliContext) (err error) {
